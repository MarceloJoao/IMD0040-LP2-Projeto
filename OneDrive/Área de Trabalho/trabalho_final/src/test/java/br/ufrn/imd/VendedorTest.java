...
/**
 * Classe de teste para a classe Vendedor.
...
public class VendedorTest {
    /**
     * Testa o cálculo do salário do Vendedor com dois dias de falta.
    ...
    public void testCalcularSalario() {
        ...
        Vendedor vendedor = new Vendedor("João", LocalDate.of(1990, 1, 1), "123.456.789-00", "Solteiro", 0,
                endereco, 3000.0f, "1234", Cargo.VENDEDOR_A, LocalDate.of(2020, 1, 1));

        float salario = vendedor.calcularSalario(2);
        assertEquals(3080.0f, salario, 0.01f);
    }

    /**
     * Testa o cálculo da rescisão do Vendedor.
    ...
    public void testCalcularRescisao() {
        ...
        float rescisao = vendedor.calcularRescisao(LocalDate.of(2023, 1, 1));
